...
public class SimpleTap : MonoBehaviour {
    ...
    public Transform Trheart;
    public Transform CursorVisual1;
    ...
    void Update() {
        ...
        {
            CursorVisual1.transform.position = hit.point;
        }
        else
        {
            CursorVisual1.transform.position = Camera.main.transform.forward * 2;
        }
    }
    ...
    private void Recognizer_TappedEvent(InteractionSourceKind source, int tapCount, Ray headRay)
    {
        ...
        if (Physics.Raycast(Camera.main.transform.position, Camera.main.transform.forward, out hit))
        {
            ...
            if (hit.transform.name == "skeleton")
            {

                Skeleton.Rotate(Vector3.up * Time.deltaTime * speed);
            ...
            if (hit.transform.name == "cube")
            {
                ...
                Trheart.gameObject.SetActive(true);
            }
        }
        else if (Physics.Raycast(Camera.main.transform.position, Camera.main.transform.forward, out hit))
        {
            if (hit.transform.name == "Heart")
            {
                ...
                Trheart.Rotate(Vector3.up * Time.deltaTime * speed);
